...
public class WebSessionLogin extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            else
            {
                ...
                GenericBeanResult genericBeanResult=null;

                //Quite onlikely, but just in case this user wants to fire
                // 2 simultaneous requests
                synchronized(connection)
                {
                    genericBeanResult = gb.getResults();
                }

                WebBeanResult webBeanResult = new WebBeanResult(genericBeanResult);

                request.setAttribute("webBeanResult", webBeanResult);
                url = "/Web_DB_Output.jsp";
            }
