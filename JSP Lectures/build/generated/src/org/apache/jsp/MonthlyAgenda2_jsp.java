...
public final class MonthlyAgenda2_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    int month_num = now.get(Calendar.MONTH);
    String[] month_arr = {"January", "February", "March", "April", "May", "June",
                      "July", "August", "September", "October", "November", "December"};
    String month = month_arr[month_num - Calendar.JANUARY];
    String nextMonth = month_arr[(month_num - Calendar.JANUARY +1) % 12];
